...
\title{
  Fit Linear Mixed Models by an OLS approach with outliers
}
\description{
Fit a Linear Mixed Model (LMM) to data, via an OLS-based approach, when outliers exist.
}
\usage{
ols.eblup.trim(Des, Y, random, independent = T, trim = 0.2, type = "F")
}
\arguments{
  \item{Des}{
