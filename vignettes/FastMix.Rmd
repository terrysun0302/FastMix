...
By checking the head of the pseeudo data, we find some inportant indexs in the prediction score function. We use `Sex` as the response variable, and rename it as `Res`. The `head()` function shows that the $5$th column is the resposne variable, and the $9, 10, 11$th columns are the interaction terms with response. Finally, we show a summary plot and table for the classification results. 
